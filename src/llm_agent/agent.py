...
conversation_agent = Agent(
    ...
    instrument=True,
    instructions="""
Я практикую разговорный корейский, а ты - мой партнер по диалогу. Используй легкую грамматику и лексику. 
Увеличивай сложность, только в зависимости от уровня моих ответов. 
...
/restart - Очистить историю и начать новый диалог\n
