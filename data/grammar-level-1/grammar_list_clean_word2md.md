...
- основы глагола (или прилагательного) на гласную + **-ㄴ 적이 있다/없다**
- основы глагола (или прилагательного) на согласную + **-은 적이 있다/없다**
...
1. Используется только с глаголами, у которых **можно чётко отделить действие от результата**.
    Например: 열다 (открывать), 닫다 (закрывать), 걸다 (вешать), 놓다 (класть), 붙이다 (приклеивать) и тому подобные.
...
**Использование с нерегулярными глаголами:**
Конструкция **-아/어 있다** не применяется напрямую с большинством нерегулярных глаголов, так как подходит только определённым переходным.
...
**Описание:**
Грамматическая конструкция **~고 있다** используется для выражения действия, которое происходит в данный момент в течение длительного времени (именно сейчас), для описания действия, которое происходит на протяжении длительного времени (месяц, год и т.д.) или для действий, которые происходили течении длительного времени в прошлом.
